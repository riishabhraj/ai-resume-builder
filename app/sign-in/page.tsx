      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl border border-brand-purple/20">
          ...
          <p className="text-center text-brand-gray-text mb-6">
            Welcome back! Sign in to continue building your resume
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="mt-2 text-right">
                <Link
                  href="/reset-password"
                  className="text-sm text-brand-purple-light hover:text-brand-purple transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-sm text-brand-gray-text mt-6">
            ...
            <Link href="/sign-up" className="text-brand-purple-light hover:text-brand-purple font-semibold transition-colors">
              Sign up
            </Link>
          </p>
        </div>
